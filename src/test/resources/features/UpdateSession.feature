Feature: Update session
  ...
  Scenario: Update an existing session
    ...
    And the following sessions will exist:
      ...
      | 1  | test@test.com | test          | tester       | 2022-09-18T18:15:47.968Z | 2022-09-18T18:15:49.965Z | 5f9e1546-d95d-49fd-9e1f-f761ad9526a7 | 2ae74a24-6a2b-4702-8917-649031a9c069 |
  ...
  Scenario: Only update datalogs that belong to the current user when updating a session
    ...
    And the following sessions will exist:
      | id | userEmail      | userFirstName | userLastName | startTime                | endTime                  | trackId                              | carId                                |
      | 1  | test@test.com  | test          | tester       | 2022-09-18T18:15:47.968Z | 2022-09-18T18:15:49.965Z | b3bb8336-c262-40e0-8bd0-c7f2bb091ff5 | 0058ca98-5c7c-4742-a93d-f29f8445baf2 |
      | 2  | test2@test.com | test 2        | tester       | 2022-09-18T18:15:47.968Z | 2022-09-18T18:15:49.965Z | b3bb8336-c262-40e0-8bd0-c7f2bb091ff5 | 0058ca98-5c7c-4742-a93d-f29f8445baf2 |
    And the following datalogs will exist:
      | id | sessionId | timestamp                | longitude          | latitude            | altitude | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | speed | throttlePosition | airFuelRatio |
