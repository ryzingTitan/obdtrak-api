Feature: Retrieve datalogs by session id
  ...
  Scenario: Retrieve datalogs for a session with a single datalog
    ...
    When the datalogs for session with id 'edc62dac-3b41-4b0e-8e2c-864c7c91fec4' are retrieved
    ...
    And the application will log the following messages:
      | level | message                                                                  |
      | INFO  | Retrieving datalogs for session id: edc62dac-3b41-4b0e-8e2c-864c7c91fec4 |
  ...
  Scenario: Retrieve datalogs for a session that does not exist
    ...
    And the user has a valid authorization token
    When the datalogs for session with id 'b8fe160d-ead5-473d-927d-950ed37c2e50' are retrieved
    Then the request response status is 'OK'
    And the following datalogs are returned:
    ...
    And the application will log the following messages:
      | level | message                                                                  |
      | INFO  | Retrieving datalogs for session id: b8fe160d-ead5-473d-927d-950ed37c2e50 |
